...
const EmailVerificationPage = () => {
  ...
  return (
    <div className="max-w-md w-full bg-white bg-opacity-90 rounded-2xl shadow-lg overflow-hidden">
      <motion.div
          ...
          <div className="flex justify-between">
            {code.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center text-2xl font-bold bg-orange-50 text-orange-700 border-2 border-orange-300 rounded-lg focus:border-orange-500 focus:outline-none"
              />
            ))}
          </div>
